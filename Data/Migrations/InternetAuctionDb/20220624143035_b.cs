...
namespace Data.Migrations.InternetAuctionDb
{
    public partial class b : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, 1, "Category 1" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, 1, new DateTime(2022, 10, 2, 17, 30, 35, 16, DateTimeKind.Local).AddTicks(9074), "Description", 12m, "lot 1", 1 });

            migrationBuilder.InsertData(
                table: "Lots",
                columns: new[] { "Id", "CategoryId", "Deadline", "Description", "InitialPrice", "Name", "OwnerId" },
                values: new object[] { 2, 1, new DateTime(2022, 10, 2, 17, 30, 35, 21, DateTimeKind.Local).AddTicks(7544), "Description", null, "lot 2", 1 });

            migrationBuilder.InsertData(
                table: "Lots",
                columns: new[] { "Id", "CategoryId", "Deadline", "Description", "InitialPrice", "Name", "OwnerId" },
                values: new object[] { 3, 2, new DateTime(2022, 10, 2, 17, 30, 35, 21, DateTimeKind.Local).AddTicks(7643), "Description", 11111m, "lot 3", 2 });
